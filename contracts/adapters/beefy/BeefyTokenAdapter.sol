...
import "../../interfaces/external/beefy/IBeefyVault.sol";
import "../../libraries/TokenUtils.sol";
import "../../libraries/Checker.sol";

/// @title  BeefyTokenAdapter
/// @author Savvy DeFi
contract BeefyTokenAdapter is ITokenAdapter, Initializable, Ownable2StepUpgradeable {
    ...
    uint256 private underlying_index;
    ...
    function price() external view override returns (uint256) {
        return IBeefyVault(token).getPricePerFullShare();
    }
   ...
   /// @inheritdoc ITokenAdapter
    ...
    function _deposit(uint256 amount, address recipient) internal returns (uint256) {
        ...
        IBeefyVault(token).deposit(amount);
    ...
    function _withdraw(uint256 amount, address recipient) internal returns (uint256) {
        ...
        IBeefyVault(token).withdraw(amount);
