...
interface ISavvyState is ISavvyTokenParams {
    ...
    function protocolTokenRequired() external view returns (bool protocolTokenRequired);

    /// @notice The address of WrapTokenGateway contract.
    ///
    /// @return wrapTokenGateway The address of WrapTokenGateway contract.
    function wrapTokenGateway() external view returns (address wrapTokenGateway);
    ...
    function borrowAllowance(address owner, address spender) external view returns (uint256 allowance);
