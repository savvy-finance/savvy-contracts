...
interface ISavvyEvents {
    ...
    event RepayLimitUpdated(address indexed baseToken, uint256 maximum, uint256 blocks);
    ...
    event RepayWithCollateralLimitUpdated(address indexed baseToken, uint256 maximum, uint256 blocks);
    ...
    event ApproveBorrow(address indexed owner, address indexed spender, uint256 amount);
    ...
    event DepositYieldToken(address indexed sender, address indexed yieldToken, uint256 amount, address recipient);
    ...
    event WithdrawYieldToken(address indexed owner, address indexed yieldToken, uint256 shares, address recipient);
    ...
    event RepayWithDebtToken(address indexed sender, uint256 amount, address recipient);
    ...
    event RepayWithBaseToken(address indexed sender, address indexed baseToken, uint256 amount, address recipient, uint256 credit);
    ...
    /// @param credit          The amount of debt that was paid-off to the account owned by owner.
    event RepayWithCollateral(address indexed owner, address indexed yieldToken, address indexed baseToken, uint256 shares, uint256 credit);
    ...
    event HarvestExceedsOffset(address indexed yieldToken, uint256 currentValue, uint256 expectedValue);
}