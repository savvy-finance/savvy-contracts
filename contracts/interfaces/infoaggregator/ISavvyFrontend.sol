...
interface ISavvyFrontend is ISavvyInfoAggregatorStructs {
    ...
    function setSavvySwap(address[] memory savvySwaps_, bool[] memory shouldAdd_) external;
    ...
    function getDashboardPageInfo(address account_)
        external
        view
        returns (DashboardPageInfo memory);
    ...
    function getPoolsPageInfo(address account_)
        external
        view
        returns (PoolsPageInfo memory);
    ...
    function getMySVYPageInfo(address account_)
        external
        view
        returns (MySVYPageInfo memory);
    ...
    function getSwapPageInfo(address account_)
        external
        view
        returns (SwapPageInfo memory);
}
